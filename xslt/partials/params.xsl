...
<xsl:stylesheet 
    ...
    <xsl:param name="directory_name">maechtekongresse-static</xsl:param>
    <xsl:param name="project_title">Mächtekongresse 1818-1822</xsl:param>
    <xsl:param name="redmine_id">10920</xsl:param>
    <xsl:param name="project_short_title">maechtekongresse</xsl:param>
